...
let handler = async (m) => {
    let pp = await conn.profilePictureUrl(m.sender, 'image').catch(_ => 'https://telegra.ph/file/160712ce84fd4d2b7ba96.jpg')
...
*❉ X Team Creator:*
Thanks To All Member X Team.
*❉ Rei:*
(Sepuh) 😱
*▸ - - - —「 Penulis Ulang 」— - - - ◂*
*❉ Rull:*
https://github.com/khrlmstfa
*▸ - - - —「 Thanks For Suhu 」— - - - ◂*
*❉ Kannachan:*
*❉ Johannes:*
*❉ Rull*
