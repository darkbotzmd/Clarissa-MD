...
let frep = { contextInfo: { externalAdReply: {title: gcname, body: bottime, sourceUrl: syt, thumbnail: fs.readFileSync('./thumbnail.jpg')}}}
...
if (!text) throw `Contoh penggunaan ${usedPrefix}${command} anjing`
    ...
    `.trim()
        await conn.sendButton(m.chat, caption, botdate, null, [
