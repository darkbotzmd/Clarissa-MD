...
let name = await conn.getName(who)
 ...
 const fliveLoc2 = {
            ...
            message: { "liveLocationMessage": { "title": `${gcname}`,`${wm2}`: wm, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
 ...
 conn.sendFile(m.chat, stiker, 'sticker.webp', '', m, null, { fileLength: 100, contextInfo: {
    ...
    mediaUrl: 'https://youtube.com/channel/UC_kZ0QiOmykIPGMbfTcErJw',
    mediaType: 1,
    description: syt,
    title: `${command} Sedang Di Proses`,
    body: botdate,
    thumbnail: await(await fetch(pp)).buffer(),
    sourceUrl: 'https://youtube.com/channel/UC_kZ0QiOmykIPGMbfTcErJw'
     }}
  })
 ...
 conn.send3ButtonImg(m.chat, result.data, `Effect *${effect}nya* Dah Jadi ${tag}`,`Subs My Channel ${global.syt}`, 'Menu', '.menu', 'Owner', '.owner', 'Sewa', '.sewa', fliveLoc2, { contextInfo: { externalAdReply: { showAdAttribution: false,
    mediaUrl: syt,
    mediaType: 1, 
    description: syt,
