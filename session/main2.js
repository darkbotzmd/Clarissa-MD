// Terus Mencoba Walau Akhirnya Pasti Error
// By Zeltoria
...
const authF = global.opts['single'] ? `${global.opts._[0] || 'session'}.json` : 'session'
...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`${owner}@s.whatsapp.net`, {text: 'Sukses Tersambung\n\nScript Ini Di Tulis Ulang Oleh Rull' })
}
